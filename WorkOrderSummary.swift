...
class WorkOrderSummary: UIViewController,UITextFieldDelegate,UITextViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        webView.loadRequest(URLRequest(url: URL(string: "http://citrix.aljaber.ae/reports/?workorder=" + woId)!))
    }
